...
- **Task:** TASK-001 â€” Inventory repository and map boundaries
- **Task file:** `tasks/TASK-001.md`

## Current Status

`READY` â€” no implementation work has started.
...
Open `tasks/TASK-001.md`, inspect the actual repository and git state, then write the module/test/migration inventory before changing code.

## Git State

- **Branch:** Unknown â€” inspect before work
- **Latest commit:** Unknown â€” inspect before work
- **Working tree status:** Unknown â€” inspect before work